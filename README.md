...
Согласно рекомендаций организаторов, акцент был на создании кликабельного прототипа  ( UI), который расположен https://sound-cling-46205278.figma.site/
Помимо этого были созданы модули mcp серверов ( файловой системы и базы данных) и агента, который с ними работает  
Так же был создан рекомендательный AI модуль (универсальный анализатор данных)  
